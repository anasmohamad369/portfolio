        ...
        <div className="relative aspect-video overflow-hidden">
          ...
          <motion.div
            ...
            className={cn(
              ...
              project.comingsoon
                ? "inset-0 flex flex-col items-center justify-center bg-background/60 backdrop-blur-[2px] z-20"
                : "top-4 right-4 flex gap-2 z-20"
            )}
          >
            {project.comingsoon ? (
              <div className="bg-background/80 px-4 py-2 rounded-full border border-primary/20 shadow-lg backdrop-blur-md">
                <span className="text-sm font-bold text-primary">Coming Soon</span>
              </div>
            ) : (
              <div className="flex gap-2">
                <Link href={project.github} target="_blank" rel="noopener noreferrer">
                  <Button size="icon" variant="secondary" className="h-8 w-8 bg-background/80 backdrop-blur-sm hover:bg-primary hover:text-primary-foreground transition-colors">
